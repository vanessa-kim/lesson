// DOM트리에서 'main' 이라는 태그를 찾음 > 해당 엘리먼트 객체를 변수 main가 가리킴
// main 변수의 DOM API를 통해, DOM에 접근하고 JS에서 직접 DOM을 컨트롤할 수 있음
const main = document.querySelector('main');
// main 엘리먼트 내부를 비우고, 템플릿리터럴의 HTML코드를 파싱하여 DOM 생성
// `스트링`은 ES6 템플릿리터럴('스트링'이 아님), 띄어쓰기나 줄바꿈 등도 그대로 사용가능
main.innerHTML = /*html*/`
